...
import 'package:life_calendar/views/auth/sign_up/sign_up_screen.dart';
      ...
      builder: (context, state) {
        return TextField(
          ...
          decoration: InputDecoration(
            labelText: 'Email',
            helperText: '',
            errorText: state.email.displayError != null ? 'Некорректный email' : null,
          ),
        );
      },
    );
      ...
      builder: (context, state) {
        return TextField(
          ...
          decoration: InputDecoration(
            ...
            helperText: '',
            errorText:
            state.password.displayError != null ? 'Некорректный пароль' : null,
          ),
        );
      },
    );
